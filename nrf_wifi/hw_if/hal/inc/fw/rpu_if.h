...
#define RPU_ADDR_PKTRAM_START 0x2F080000
#define RPU_ADDR_PKTRAM_END   0x2F0E0000
#define RPU_ADDR_GDRAM_START 0x2F000000
#define RPU_ADDR_GDRAM_END   0x2F0F0000
/*#define RPU_PKTRAM_OFFSET 0x180000*/
#define RPU_ADDR_RAM0_START 0x28000000
#define RPU_ADDR_RAM0_END   0x2807FFFF
/*#define RPU_RAM0_OFFSET 0x100000*/
#define RPU_ADDR_GRAM_START 0x28000000
#define RPU_ADDR_GRAM_END 0x2807FFFF
/*#define RPU_GRAM_PKD_OFFSET 0x3c0000*/
#define RPU_ADDR_SBUS_START 0x48000000
#define RPU_ADDR_SBUS_END 0x480FFFFF
/*#define RPU_SYSBUS_REGS_OFFSET 0x000000*/
#define RPU_ADDR_PBUS_START 0x48000000
#define RPU_ADDR_PBUS_END   0x480FFFFF
/*#define RPU_PERIP_BUS_REGS_OFFSET 0x000000*/
#define RPU_ADDR_CODE_RAM_START 0x0E000000
#define RPU_ADDR_CODE_RAM_END   0x0E07FFFF
/*#define RPU_CODE_RAM_REGS_OFFSET 0x300000*/
#define RPU_ADDR_SECURERAM_START 0x28300000
#define RPU_ADDR_SECURERAM_END   0x2831FFFF
/*#define RPU_SECURERAM_REGS_OFFSET 0x3e0000*/
#define RPU_ADDR_BELLBOARD_REGION 0x4F000000
#define RPU_ADDR_BELLBOARD_START 0x4F090000
#define RPU_ADDR_BELLBOARD_END   0x4F09FFFF
/*#define RPU_BELLBOARD_REGS_OFFSET 0x380000*/
...
#define RPU_BELLBOARD_ADDR_MASK_OFFSET 0x0000FFFF
#else
...
#ifdef CONFIG_NRF_WIFI_SOC_VEGA
#define RPU_MEM_RX_CMD_BASE 0x28000008
#define VEGA_RPU_REG_INT_FROM_MCU_CTRL  0x4F09A300
#define VEGA_RPU_REG_INT_FROM_MCU_CLR   0x4F09A100
#define VEGA_RPU_REG_INT_TO_WIFICORE_BELLBOARD_TASKS_TRIGGER    0x4F09C000
#else
#define RPU_MEM_RX_CMD_BASE 0xB7000D58
#endif
#ifdef CONFIG_NRF_WIFI_SOC_VEGA
#define RPU_MEM_HPQ_INFO 0x2F080024
#define RPU_MEM_TX_CMD_BASE 0x2F0800B8
#define RPU_MEM_OTP_INFO 0x2F08005C
#define RPU_MEM_OTP_INFO_FLAGS 0x2F084FDC
#define RPU_MEM_LMAC_IF_INFO 0x2F084FE0
#define RPU_MEM_PKT_BASE 0x2F085000
#define RPU_MEM_OTP_FT_PROG_VERSION 0x2F084FD8
#define RPU_MEM_OTP_PACKAGE_TYPE 0x2F084FD4
#else
